...
from config import (
    LARGURA, ALTURA, DIR_SPRITES, DIR_PROJETO,
...
class CarroFisica:
    ...
    def aplicar_upgrades(self, upgrades):
        ...
        tem_slick_nitro = any('slick_nitro' in uid for uid in slick_upgrades)
            ...
            try:
                ...
                if cor_final:
                    ...
                    estagios = [
                        ...
                        "Car1_lataria",
                        "Car1_lataria",  # Estágio 2 (drift) usa mesmo sprite de lataria
                        "Car1_bodykit"
                    ]
                ...
                if os.path.exists(caminho_sprite_campanha):
                    caminho_sprite = caminho_sprite_campanha
