...
def main():
    ...
    cmd.append("--hidden-import=core.menu_controles")
    cmd.append("--hidden-import=core.i18n")
    cmd.append("--hidden-import=core.pista_tiles")
    cmd.append("--hidden-import=core.pista_grip")
    ...
    cmd.append("--hidden-import=core.gamepad_manager")
    cmd.append("--hidden-import=core.ghost")
    cmd.append("--hidden-import=core.achievements")
    cmd.append("--hidden-import=core.popup_achievement")
    cmd.append("--hidden-import=core.estatisticas")
    cmd.append("--hidden-import=core.desafios")
    cmd.append("--hidden-import=core.mercador_alien")
    cmd.append("--hidden-import=core.crank")
    cmd.append("--hidden-import=core.rex")
    cmd.append("--hidden-import=core.glub")
    cmd.append("--hidden-import=core.akira")
    cmd.append("--hidden-import=core.ranking")
    cmd.append("--hidden-import=core.missoes")
    cmd.append("--hidden-import=core.status_jogador")
    cmd.append("--hidden-import=core.tempo_jogo")
    cmd.append("--hidden-import=core.celular")
    cmd.append("--hidden-import=core.casa")
    cmd.append("--hidden-import=core.hub_territorio")
    cmd.append("--hidden-import=core.mapa_cidade")
    cmd.append("--hidden-import=core.mapa_locations")
    cmd.append("--hidden-import=core.territorios")
    cmd.append("--hidden-import=core.narrative_system")
    cmd.append("--hidden-import=core.pixel")
    cmd.append("--hidden-import=core.boris")
    cmd.append("--hidden-import=core.barao")
    cmd.append("--hidden-import=core.fuligem")
