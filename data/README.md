...
Esta pasta contém arquivos de dados e configurações do Turbo Racer.
...
**Conteúdo:**
- Configurações de áudio (volume, música)
- Configurações de vídeo (resolução, fullscreen)
...
**Conteúdo:** Checkpoints salvos em formato antigo  
**Status:** Arquivo de backup - não é mais usado pelo sistema atual
